...
![**Fig. 1 ([source](https://www.researchgate.net/figure/Schematics-of-the-Illumina-and-ONT-sequencing-procedure-A-Illumina-sequencing-1-2_fig1_364792307)).** Schematic of Illumina short-read sequencing.](images/illumina.jpg){width=80%}
...
![**Fig. 2.** Using overlapping sequencing reads to assemble a genome.](images/assembly.jpg)
...
![**Fig. 3.** How repetitive sequences affect genome assembly.](images/repeats.jpg)
...
![**Fig. 4.** Sample composition of the human reference genome.](images/hg38.png){width=50%}
...
![**Fig. 5.** UCSC genome browser homepage.](images/ucsc1.png)
...
![**Fig. 6.** Viewing one genomic region in the UCSC genome browser.](images/ucsc2.jpg)
...
![**Fig. 7.** Clicking on the _POMC_ gene track.](images/ucsc3.jpg)

<br></br>
(Note that if you click on whitespace instead of an annotation element, it will change the track's display density instead.)

![**Fig. 8.** Clicking on whitespace to expand the RefSeq genes track.](images/ucsc4.jpg)
...
![**Fig. 9.** Adding the "clone ends" track to the browser.](images/ucsc5.jpg)
...
![**Fig. 10.** Viewing the "clone ends" track.](images/ucsc6.jpg)
...
![**Fig. 11.** The IGV homepage.](images/igv1.jpg)
...
![**Fig. 12.** Viewing a gene in IGV.](images/igv2.jpg)
...
![**Fig. 13.** Loading reads from a 1KG sample.](images/igv3.png)
...
![**Fig. 14.** Regions sampled by the 1000 Genomes Project.](images/kgp1.jpg)
...
![**Fig. 15.** The data portal includes information about the samples in this dataset.](images/kgp2.png)
...
![**Fig. 16.** Finding sequencing data in SRA.](images/kgp3.png)
...
![**Fig. 17.** The `Reads` tab in SRA.](images/kgp5.png)
...
![**Fig. 18.** The `Reads` tab in SRA.](images/igv4.jpg)
...
![**Fig. 19.** Viewing additional info for one sequencing read.](images/igv5.png)
...
![**Fig. 20.** Two of these colored bases are probably real SNPs, and two are probably errors.](images/igv6.jpg)
