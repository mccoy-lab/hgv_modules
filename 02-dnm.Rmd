...
```{r}
# load the `age` data
age <- read.table("https://www.dropbox.com/s/lkxfr2t43c9nz6n/aau1043_datas7.tsv.gz?dl=1", sep = "\t", header = TRUE, skip = 4)
age
```
...
crossovers <- read.table("https://www.dropbox.com/s/imk845vw1uvnixy/aau1043_datas4.gz?dl=1", sep = "\t", skip = 10)
head(crossovers)
```
