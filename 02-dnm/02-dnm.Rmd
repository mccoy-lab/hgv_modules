...
![**Fig. 1.** Sources of DNMs in gametogenesis.](images/gametogenesis_figure.png)
...
![**Fig. 2.** Possible outcomes for double-strand breaks generated during meiosis I. Adapted from *Molecular Biology of the Cell, 6th Edition* (Alberts et al.)](images/recombination_figure.png)
...
```{r}
# read data
crossovers <- read.table("crossovers.tsv.gz", header = TRUE)
