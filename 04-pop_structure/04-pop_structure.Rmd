...
One common liftover tool [is provided by the UCSC Genome Browser](https://genome.ucsc.edu/cgi-bin/hgLiftOver).

***
<details><summary> Navigate to the UCSC liftover page. </summary>

Select the assemblies that you want to change coordinates between.

![**Fig. 4.** Selecting assemblies for liftover.](04-pop_structure/images/liftover1.png)

In the box, enter the coordinates of our variant of interest. Note that we have to enter these coordinates in `chr:pos-pos` format (`chr21:17753762-17753762` for our SNP).

Hit the `Submit` button. This will generate a file that you can download, which will contain the hg19 coordinates of our variant.
