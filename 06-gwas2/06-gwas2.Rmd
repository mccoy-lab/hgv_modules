...
As in the population structure module, our genotype data is stored in a [**Variant Call Format (VCF)**](https://mccoy-lab.github.io/hgv_modules/variant-call-format-vcf.html) file. The `genotypes_subset.vcf` file is a small subset of a much larger VCF that we'll use later to run a genome-wide GWAS.
