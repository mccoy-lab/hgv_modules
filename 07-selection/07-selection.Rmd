...
We're working with genotype data, in **VCF** form, from the 1000 Genomes Project.
...
![**Fig. 9.** EHH measures how likely two haplotypes are to carry the same variant at a given location -- a signature that we expect recent selection to exaggerate.](07-selection/images/ehh.jpg){width=80%}
