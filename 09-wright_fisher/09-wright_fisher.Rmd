...
Both drift and selection occur in real populations, but drift is thought to be the [primary driver](https://www.nature.com/scitable/topicpage/neutral-theory-the-null-hypothesis-of-molecular-839/) of allele frequency changes, outweighing the impacts of selection.
...
An allele becomes **fixed** in a population when it reaches an allele frequency of either 0 or 1. At either of these points, it is no longer considered a variable site because either everyone or no one in the population carries it.

<center>

![**Fig. 2 ([source](https://sites.radford.edu/~rsheehy/Gen_flash/popgen/)).** Alleles are considered fixed at `AF = 0` or `AF = `.](09-wright_fisher/images/fixation.png)
...
# simulate a very small population
results <- run_sim(Ne = 10, freq = 0.5, generations = 1000)
