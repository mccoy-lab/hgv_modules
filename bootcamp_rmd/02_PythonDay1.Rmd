...
Some methods *do* in fact modify underlying variables. For example, the list `.append()` method which we will learn about *does* change the list if operates on, so in the following code block: 
