...
These three functions remove any instances of unwanted characters on either the right side, left side, or both sides of a string, respectively. You can provide the characters you want to remove as an argument:

```{r, engine='python'}
"ricercar........,,,,,,".rstrip(",.")
```

Without an argument, we remove spaces: 

```{r, engine='python'}
"          gradus ad Parnassum ".lstrip()
```
